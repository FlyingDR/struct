...
class DateTimeTest extends BaseTypeTest
{
    ...
    {
        // Make sure that both default value and value generated by test class will fit into same second
        do {
            usleep(5000);
            $ms = (int)(new \DateTime())->format('u');
        } while ($ms > 100000);
        ...
        $format = 'r';
        static::assertEquals($value->format($format), $defaultValue->format($format));
    }
